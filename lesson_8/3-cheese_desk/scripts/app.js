let app = {
     ...
     * td (ячейкам).
     * @param {string} startWithColor с какого цвета строка начинается от
     *  левого края, м.б. "white", "black".
     * @param {number} rowNum номер строки от 8 до 1, т.к. шахматная доска
     * формируется сверху вниз, поэтому номер начинается с 8.
